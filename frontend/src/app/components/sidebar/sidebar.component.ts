    ...
    <aside class="sidebar" [class.collapsed]="!(sidebarService.sidebarOpen$ | async)">
      ...
      <nav class="sidebar-nav">
        ...
        <a class="nav-item" routerLink="/invitations" routerLinkActive="active">
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor"><path d="M16 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path><circle cx="8.5" cy="7" r="4"></circle><line x1="20" y1="8" x2="20" y2="14"></line><line x1="17" y1="11" x2="23" y2="11"></line></svg>
          Invitations
        </a>
