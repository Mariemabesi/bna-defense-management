    ...
    <div class="app-layout">
      ...
      <main class="main-content">
        ...
        <div class="dashboard-content">
          ...
          <!-- TAB 2: DOSSIERS TO FINALIZE -->
          <div class="table-container" *ngIf="activeTab === 'FINAL'">
            <table>
              <thead>
                <tr>
                  <th>Référence</th>
          ...
          <div class="table-container" *ngIf="activeTab === 'BUDGET'">
            <table>
              <thead>
                <tr>
                  <th>Dossier</th>
...
export class MesFraisComponent implements OnInit {
  ...
  loadMyDossiers(): void {
    // We load dossiers for the dropdown
