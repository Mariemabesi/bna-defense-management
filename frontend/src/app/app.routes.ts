...
export const routes: Routes = [
    ...
    { path: 'admin/chat', redirectTo: 'chat' },
    { path: 'chat', loadComponent: () => import('./components/admin-chat/admin-chat.component').then(m => m.AdminChatComponent), canActivate: [authGuard] },
